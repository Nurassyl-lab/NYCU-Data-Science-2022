...
pickle.dump(rf_classifier, open('random_forest.pkl', 'wb'))
pickle.dump(dt_classifier, open('decision_tree.pkl', 'wb'))
pickle.dump(kn_classifier, open('k_neighbours.pkl', 'wb'))